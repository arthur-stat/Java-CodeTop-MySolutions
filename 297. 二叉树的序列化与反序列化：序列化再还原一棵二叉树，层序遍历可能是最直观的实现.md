...
在 [428. 序列化和反序列化 N 叉树](https://leetcode.cn/problems/serialize-and-deserialize-n-ary-tree/description/) 中，我们序列化并反序列化了 N 叉树。可以考虑层序遍历，在序列化时不仅记录当前节点的值，同时也记录子节点的数量即可。显然，本问题只是序列化 N 叉树的特例。
